...
const About = () => {
  return (
    <div className='bg-indigo-800 text-white p-4'>
        ...
        <p>FinNance was born out of a need for a better financial management solution. We wanted to create a tool that goes beyond basic expense tracking—one that offers  real-time analytics, and an intuitive interface to help users make smarter financial decisions.</p>
   ...
   {newFeatures.map((ft,i)=><div key={i}>
    <span>{ft.icon}</span>
    <span className='text-gray-200 font-semibold'>{ft.title}</span>
