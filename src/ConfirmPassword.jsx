...
const ConfirmPassword = ({setdBoxOpen,password,setPassword,action,message}) => {
  return (
    <div className='relative bg-white mb-2 border border-blue-300 p-2'>
        ...
        <button type='submit' onClick={action} className='bg-green-400 p-1 rounded-sm min-w-[180px] cursor-pointer hover:bg-green-500 '>Confirm</button>   
